...
import { fetchGraphSummary } from "../lib/api";
    ...
    <div className="p-8 space-y-8 animate-fade-in max-w-6xl">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-black tracking-tight text-white uppercase italic">
          Guardian AI Model Card
        </h2>
        <p className="text-gray-500 mt-1">
          Transparency report for Tower 1 Machine Learning architecture
        </p>
      </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 bg-dash-bg">
            ...
            <ul className="text-xs text-gray-400 space-y-3 list-disc pl-4 leading-relaxed">
              <li>
                Geographic bias towards Indo-Pacific and sub-continental
                logistics corridors.
              </li>
              <li>
                Extreme weather prediction relies on external NOAA APIs which
                may introduce latency.
              </li>
              <li>
                Force Majeure events (pandemics, canal blockages) fall outside
                trained confidence intervals (&gt;3 sigma).
              </li>
            </ul>
          </div>

          {/* ── GRAPH SUMMARY ── */}
          <div className="glass-card rounded-2xl p-6 border-l-4 border-dash-green">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4 flex items-center gap-2">
              <Network className="w-4 h-4 text-dash-green" /> Graph Summary
            </h3>
            {statsLoading ? (
              ...
              <div className="space-y-3 text-xs">
                <div className="flex justify-between border-b border-white/5 pb-2">
                  ...
                  <span className="text-white font-black text-sm">
                    {graphStats?.shipment_count ?? graphStats?.shipments ?? "—"}
                  </span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <span className="text-gray-500 font-bold uppercase">
                ...
                <div className="flex justify-between pb-2">
                  ...
                  <span className="text-dash-risk font-black text-sm">
                    {graphStats?.high_risk_count ??
                      graphStats?.high_risk_nodes ??
                      "—"}
                  </span>
                </div>
                {graphStats && (
        ...
        <div className="col-span-12 lg:col-span-8 space-y-6">
          ...
          <div className="glass-card rounded-3xl p-8">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-6 flex items-center gap-2">
              <Activity className="w-4 h-4 text-dash-green" /> Validation
              Metrics
            </h3>
          ...
          <div className="glass-card rounded-3xl p-8 text-sm">
            <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4 flex items-center gap-2">
              <FileText className="w-4 h-4 text-white" /> Feature Importance
              (Top 5)
            </h3>
  ...
  return (
    <div>
      ...
      <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
        <div
          className="h-full bg-dash-accent/80 rounded-full"
          style={{ width: `${val}%` }}
        />
      </div>
    </div>
